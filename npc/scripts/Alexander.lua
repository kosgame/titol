...
shopModule:addBuyableItem({'stone shower rune'}, 2288, 150, 1, 'stone shower rune')
shopModule:addBuyableItem({'thunderstorm rune'}, 2315, 150, 1, 'thunderstorm rune')
shopModule:addBuyableItem({'icicle rune'}, 2271, 150, 1, 'icicle rune')
shopModule:addBuyableItem({'holy missile rune'}, 2295, 80, 1, 'holy missile rune')
shopModule:addBuyableItem({'desintegrate rune'}, 2310, 80, 1, 'desintegrate rune')
shopModule:addBuyableItem({'poison bomb rune'}, 2286, 170, 1, 'poison bomb rune')
shopModule:addBuyableItem({'energy bomb rune'}, 2262, 325, 1, 'energy bomb rune')
shopModule:addBuyableItem({'soulfire rune'}, 2308, 210, 1, 'soulfire rune')
...
shopModule:addBuyableItem({'fireball rune'}, 2302, 150, 1, 'fireball rune')
shopModule:addBuyableItem({'wild growth rune'}, 2269, 320, 1, 'wild growth rune')
