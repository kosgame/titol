local keywordHandler = KeywordHandler:new()
        ...
        local travelNode = keywordHandler:addKeyword({'cormaya'}, StdModule.travel, {npcHandler = npcHandler, premium = true, level = 0, cost = 0, destination = {x=33287, y=31956, z=6} })
			
			 local travelNode = keywordHandler:addKeyword({'back'}, StdModule.travel, {npcHandler = npcHandler, premium = true, level = 0, cost = 0, destination = {x=33287, y=31956, z=6} })
